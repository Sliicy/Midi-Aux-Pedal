...
namespace Midi_Aux_Pedal {
    public partial class MainForm : Form {
        ...
        readonly MMDeviceEnumerator en = new MMDeviceEnumerator();
        
        private void Form1_Load(object sender, EventArgs e) {
            var devices = en.EnumerateAudioEndPoints(DataFlow.All, DeviceState.Active);
            AudioList.Items.AddRange(devices.ToArray());

            if (Environment.GetCommandLineArgs().Length > 1) {
                try {
                    AudioList.SelectedIndex = int.Parse(Environment.GetCommandLineArgs()[1]) - 1;
                } catch {
                    Console.WriteLine("Optionally enter a number representing the audio device to automatically use. (Example: \"Midi Aux Pedal.exe 2\" will select the 2nd audio device.");
                }
            }
...
/// <summary>
/// Source obtained from https://stackoverflow.com/questions/35138778/sending-keys-to-a-directx-game.
/// </summary>
